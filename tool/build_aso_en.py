...
SUBTITLE = "Compress video, audio, photo"
KEYWORDS = ("mp4,mp3,gif,heic,mov,mkv,webm,avi,wav,flac,m4a,webp,avif,"
            "shrink,reduce,size,trim,crop,batch,offline")
PROMO = ("Convert and compress on the phone itself. No account, no ads, "
         "no subscriptions, and no internet — the app has no networking at all.")

DESCRIPTION = """Eluna Media converts and compresses video, audio and photos entirely on your iPhone. No account, no ads, no subscriptions, no watermarks — and no internet connection, because the app has no networking code in it at all. Your files never leave the device. Airplane mode changes nothing.
