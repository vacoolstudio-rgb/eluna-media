...
class L10nRu extends L10n {
  ...
  String get privacyBody =>
      'Eluna Media конвертирует файлы целиком на этом устройстве с помощью встроенной сборки FFmpeg. Файлы никогда не покидают устройство, учётная запись не нужна, телеметрии нет. Единственное, что использует сеть, — один неперсонализированный рекламный баннер; во время конвертации он не загружается. Подробности — на экране «Сеть и приватность».\n\nУдаление метаданных включено по умолчанию, поэтому EXIF, координаты GPS и отметки времени не попадают в экспортируемые файлы.';
  ...
  String get introAdNote =>
      'В бесплатной версии один неперсонализированный баннер — никогда во время конвертации, а первые 14 дней рекламы нет вовсе.';
  ...
  @override
  String get adPrivacyTitle => 'Настройки рекламы';

  @override
  String get adPrivacySubtitle => 'Изменить согласие на показ рекламы';
  ...
  String get netAuditAdTitle =>
      'Рекламный баннер — единственный потребитель сети';

  @override
  String get netAuditAdBody =>
      'Один баннер, только неперсонализированные запросы — разрешение на рекламный идентификатор полностью вырезано из приложения. Он не загружается, пока идёт конвертация, и исчезает после «Убрать рекламу». Кроме него, сеть затрагивает только системный диалог магазина по кнопке «Оценить приложение».';
  ...
  String get removeAdsSubtitle =>
      'Разовая покупка. Все функции и так бесплатны.';

  @override
  String get removeAdsBullet1 => 'Баннер исчезает навсегда';

  @override
  String get removeAdsBullet2 => 'Один платёж — никакой подписки';

  @override
  String get removeAdsBullet3 => 'Все функции остаются бесплатными для всех';
  ...
  String get purchaseSuccess =>
      'Реклама убрана. Спасибо за поддержку разработки!';
  ...
  @override
  String get purchaseFailed => 'Покупка не прошла.';

  @override
  String get adFreeBadge => 'Без рекламы';
  ...
  String get whatsNew1 =>
      'Достижения — приватные, считаются только на устройстве.';

  @override
  String get whatsNew2 => 'Склейка видео: несколько роликов в один MP4.';

  @override
  String get whatsNew3 =>
      'Аппаратное кодирование — быстрее и холоднее на поддерживаемых устройствах.';

  @override
  String get whatsNew4 =>
      'Кадрирование 1:1 / 9:16 / 16:9, громкость, скорость 0.25–4×.';

  @override
  String get whatsNew5 =>
      'Опциональный двухпроходный режим для точного размера.';
