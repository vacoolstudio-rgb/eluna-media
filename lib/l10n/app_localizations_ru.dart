...
class L10nRu extends L10n {
  ...
  String startConversion(int count) {
    return 'Конвертировать файлы ($count)';
  }
  ...
  String batchCompleted(int done) {
    return 'Конвертировано файлов: $done';
  }
  ...
  String get introFreeNote =>
      'Бесплатно: без рекламы и без подписок. Все функции, включая пакетную обработку, доступны сразу — купить можно только чаевые, и они ничего не открывают.';
  ...
  String mergedVideoName(int count) {
    return 'Склеенное видео ($count).mp4';
  }
  ...
  String get mediaAccessRequired =>
      'Чтобы удалять оригиналы, нужен доступ к медиатеке.';
