...
class L10nPt extends L10n {
  ...
  String startConversion(int count) {
    return 'Converter arquivos ($count)';
  }
  ...
  String batchCompleted(int done) {
    return 'Arquivos convertidos: $done';
  }
  ...
  String selectedFiles(int count) {
    return 'Arquivos selecionados: $count';
  }
  ...
  String filesReceived(int count) {
    return 'Arquivos recebidos: $count';
  }
  ...
  @override
  String get codecNoVideo => 'Sem vídeo';

  @override
  String get codecNoAudio => 'Sem áudio';

  @override
  String codecLossless(String codec) {
    return '$codec (sem perdas)';
  }
