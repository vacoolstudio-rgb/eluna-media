...
class L10nUk extends L10n {
  ...
  String startConversion(int count) {
    return 'Конвертувати файли ($count)';
  }
  ...
  String batchCompleted(int done) {
    return 'Конвертовано файлів: $done';
  }
  ...
  String get introFreeNote =>
      'Безкоштовно: без реклами й без підписок. Усі функції, зокрема пакетна обробка, доступні одразу — купити можна лише чайові, і вони нічого не відкривають.';
  ...
  String mergedVideoName(int count) {
    return 'Склеєне відео ($count).mp4';
  }
  ...
  @override
  String get netAuditTipsTitle => 'Чайові';

  @override
  String get netAuditTipsBody =>
      'Чайові проводить застосунок Play Store, а не цей — дозволу на інтернет у нього досі немає. Разом із покупками у списку дозволів з\'являються два рядки: «покупки в застосунку» та «перегляд мережевих підключень»; другий лише дізнається, чи є з\'єднання, але не може ним скористатися. Ніщо не купується саме, і чайові нічого не відкривають: усі можливості безкоштовні.';
  ...
  @override
  String get renameOutput => 'Перейменувати результат';

  @override
  String get renameOutputHint => 'Нова назва';

  @override
  String get renameOutputHelp =>
      'Розширення задає обраний формат. Залиште порожнім — результат назветься за вихідним файлом.';

  @override
  String deleteOriginalsAction(int count) {
    return 'Видалити оригінали ($count)';
  }

  @override
  String get deleteOriginalsAuto => 'Видаляти оригінали після конвертації';

  @override
  String get deleteOriginalsHint =>
      'Просить систему видалити вихідні файли після того, як результат збережено. Система завжди показує, що саме зникне, і чекає на ваше підтвердження.';

  @override
  String get mediaAccessRequired =>
      'Щоб видаляти оригінали, потрібен доступ до медіатеки.';

  @override
  String originalsDeleted(String size) {
    return 'Оригінали видалено — звільнено $size';
  }

  @override
  String get originalsNoneDeleted =>
      'Нічого не видалено. Знайти можна лише файли, які галерея зберігає під первісною назвою.';
