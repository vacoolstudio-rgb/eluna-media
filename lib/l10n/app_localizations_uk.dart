...
class L10nUk extends L10n {
  ...
  String get privacyBody =>
      'Eluna Media конвертує файли повністю на цьому пристрої за допомогою вбудованої збірки FFmpeg. Файли ніколи не залишають пристрій, обліковий запис не потрібен, телеметрії немає. Єдине, що використовує мережу, — один неперсоналізований рекламний банер; під час конвертації він не завантажується. Повний аудит — на екрані «Мережа і приватність».\n\nВидалення метаданих увімкнено за замовчуванням, тому EXIF, координати GPS і часові мітки не потрапляють до експортованих файлів.';
  ...
  String get introAdNote =>
      'У безкоштовній версії один неперсоналізований банер — ніколи під час конвертації, а перші 14 днів реклами немає взагалі.';
  ...
  @override
  String get netAuditAdTitle => 'Рекламний банер — єдиний споживач мережі';

  @override
  String get netAuditAdBody =>
      'Один банер, лише неперсоналізовані запити — дозвіл на рекламний ідентифікатор повністю вирізано із застосунку. Він не завантажується, поки триває конвертація, і зникає після «Прибрати рекламу». Крім нього, мережі торкається лише системний діалог магазину за кнопкою «Оцінити застосунок».';
  ...
  @override
  String get removeAdsTitle => 'Прибрати рекламу';

  @override
  String get removeAdsSubtitle =>
      'Разова покупка. Усі функції і так безкоштовні.';

  @override
  String get removeAdsBullet1 => 'Банер зникає назавжди';

  @override
  String get removeAdsBullet2 => 'Один платіж — жодних підписок';

  @override
  String get removeAdsBullet3 =>
      'Усі функції залишаються безкоштовними для всіх';
  ...
  String get purchaseSuccess =>
      'Рекламу прибрано. Дякуємо за підтримку розробки!';

  @override
  String get purchaseUnavailable =>
      'Магазин зараз недоступний. Спробуйте пізніше.';

  @override
  String get purchaseFailed => 'Покупка не пройшла.';

  @override
  String get adFreeBadge => 'Без реклами';
  ...
  @override
  String get whatsNew1 => 'Досягнення — приватні, рахуються лише на пристрої.';

  @override
  String get whatsNew2 => 'Склеювання відео: кілька роликів в один MP4.';

  @override
  String get whatsNew3 =>
      'Апаратне кодування — швидше й холодніше на підтримуваних пристроях.';

  @override
  String get whatsNew4 =>
      'Кадрування 1:1 / 9:16 / 16:9, гучність, швидкість 0,25–4×.';

  @override
  String get whatsNew5 => 'Опційний двопрохідний режим для точного розміру.';
